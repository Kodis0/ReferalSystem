...
function PasskeyIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" aria-hidden>
      <path
        fill="#c4b5fd"
        d="M12 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-9 9a9 9 0 0 1 18 0h-2a7 7 0 0 0-14 0H3z"
      />
      <path
        fill="#a78bfa"
        d="M17 9h2v3h-2V9zm-1 3h4v2h-1.5v5h-2v-5H16v-2zm3-5a1.5 1.5 0 0 1 1.5 1.5v1H16V8.5A1.5 1.5 0 0 1 17.5 7z"
      />
    </svg>
  );
}
